// js/noticias.js – versão completa com hero clicável e texto formatado
document.addEventListener("DOMContentLoaded", () => {
  ...
  function updateHero() {
    const now = new Date();
    let activeRace = calendar2026[0]; // default Austrália no início
    ...
    // Hero clicável leva ao card da corrida
  ...
  updateHero();
  generateCards();
  setInterval(updateHero, 1000); // Atualiza a cada segundo para o countdown
